...
const _hooks = {};
/** Modos de aplicación registrados por plugins */
const _pluginAppModes = {};

/** Ids permitidos en esta línea de producto (coincide con capacidades OSS/replay). */
...
export async function loadExternalPlugins() {
    ...
    /* Sin import() de static/plugins: esta rama no enlaza chunks opcionales (Parquet, MAVLink, etc.). */
