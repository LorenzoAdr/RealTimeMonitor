...
const I18N = {
    es: {
        ...
        arincRegistryLoadServerConfirm: "¿Reemplazar el registro local por el guardado en el servidor?",
    ...
    en: {
        ...
        arincRegistryLoadServerConfirm: "Replace the local registry with the one stored on the server?",
